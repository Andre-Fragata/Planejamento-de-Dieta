...
def buscar_alimentos_csv(arquivo_csv, criterios_busca, intervalo_calorias=None):
    resultados = []
...
resultados = buscar_alimentos_csv(arquivo_csv, criterios_busca, intervalo_calorias)
